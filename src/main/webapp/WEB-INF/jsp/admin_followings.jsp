...
<tr>
<td width="50"><%=cnt++%></td>
<td width="150"><input id="following_id" type="text" value=<%=following_id%>><button type="button" onclick="update_users('<%=user_id%>',this)" >수정</button></td>
